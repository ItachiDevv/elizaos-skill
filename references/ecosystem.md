...
Organization: https://github.com/elizaOS (13 public repositories — verified 2026-08-31)

## Core Framework

| Repository | Stars | Description |
|-----------|-------|-------------|
| **eliza** | 19.2k | Main monorepo — polyglot v2 beta (`develop` branch, `2.0.4+`). Packages: ~30 packages under `packages/` plus 111 first-party plugins under top-level `plugins/`. MIT licensed. |
