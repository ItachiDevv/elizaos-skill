...
Organization: https://github.com/elizaOS (12 repositories — verified 2026-06-15)

## Core Framework

| Repository | Stars | Description |
|-----------|-------|-------------|
| **eliza** | 18.6k | Main monorepo — v2 stable/beta (`develop` branch, `2.0.0-beta.0`; latest stable tag `v2.0.3`). 49 packages in `packages/` and 127+ first-party plugins under top-level `plugins/`. MIT licensed. |
