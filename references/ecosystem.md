...
Organization: https://github.com/elizaOS (13 public repositories — verified 2026-07-20)

## Core Framework

| Repository | Stars | Description |
|-----------|-------|-------------|
| **eliza** | 18.8k | Main monorepo — v2 beta (`develop` branch, `2.0.4`). 39 packages under `packages/` plus 140+ first-party plugins under top-level `plugins/`. MIT licensed. |
