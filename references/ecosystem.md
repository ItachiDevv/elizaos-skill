...
Organization: https://github.com/elizaOS (verified 2026-07-13)

## Core Framework

| Repository | Stars | Description |
|-----------|-------|-------------|
| **eliza** | 18.7k | Main monorepo — v2 beta (`develop` branch, `2.0.4`; latest tag `v2.0.3-beta.7`). 39 packages (incl. core, cloud, auth, native, os, vault, browser-extension) plus 104+ first-party plugins under top-level `plugins/`. CLI renamed from `@elizaos/cli` to `elizaos`. MIT licensed. |
