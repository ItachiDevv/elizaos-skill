...
Organization: https://github.com/elizaOS (12 public repositories — verified 2026-06-22)

## Core Framework

| Repository | Stars | Description |
|-----------|-------|-------------|
| **eliza** | 18.6k | Main monorepo — v2 beta (`develop` branch, `2.0.4`, latest tag `v2.0.3-beta.2`). 49 packages including cloud platform suite, native plugins, and core SDK (renamed from `typescript/` to `core/`). 130+ first-party plugins under top-level `plugins/`. MIT licensed. |
