...
Organization: https://github.com/elizaOS (19 repositories — verified 2026-08-17)

## Core Framework

| Repository | Stars | Description |
|-----------|-------|-------------|
| **eliza** | 19.1k | Main monorepo — TypeScript v2 beta (`develop` branch, `2.0.12-beta.0+`). ~30 packages under `packages/` (core, agent, app, elizaos, native, cloud, os, auth, ui, etc.) plus ~127 first-party plugins under top-level `plugins/`. Python/Rust SDKs removed. MIT licensed. |
