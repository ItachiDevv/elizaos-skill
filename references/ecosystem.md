...
Organization: https://github.com/elizaOS (13 public repositories — verified 2026-08-10)

## Core Framework

| Repository | Stars | Description |
|-----------|-------|-------------|
| **eliza** | 19.0k | Main monorepo — v2 (`develop` branch, `2.0.4`). Packages: `agent, app, app-core, auth, cloud, core, elizaos, evidence, logger, native, prompts, registry, scripts, shared, skills, test, training, ui, vault` plus 130 first-party plugins under top-level `plugins/`. MIT licensed. |
