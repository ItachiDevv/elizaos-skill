...
Organization: https://github.com/elizaOS (13 public repositories — verified 2026-07-27)

## Core Framework

| Repository | Stars | Description |
|-----------|-------|-------------|
| **eliza** | 18.8k | Main monorepo — TypeScript v2 beta (`develop` branch, `2.0.4`). Packages: 39 packages including `agent, app, app-core, auth, cloud, core, elizaos, native, os, shared, skills, ui, vault` plus 100+ first-party plugins under top-level `plugins/`. MIT licensed. |
